...
<style>
        ...
        .btn-color {
    background-color: rgb(250, 238, 206); /* Cambia el color de fondo al pasar el mouse */
    color: rgd(255,255,255); /* Cambia el color del texto al pasar el mouse */
    
}

.btn-color:hover {
    background-color: rgb(250, 238, 206); /* Color de fondo inicial */
...
<body class="bg-gradient navcolor">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5 align-items-center">
                                    ...
                                    <form class="user" method="POST" action="" autocomplete="off">
                                        ...
                                        <button type="submit" class="btn btn-color btn-user btn-block">
                                            Login
                                        </button>
                                        <hr>
                                    </form>
