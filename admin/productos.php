...
if (isset($_POST)) {
    if (!empty($_POST)) {
        ...
        $query = mysqli_query($conexion, "INSERT INTO productos(nombre, descripcion, precio, cantidad, imagen, id_categoria) VALUES ('$nombre', '$descripcion', '$precio', $cantidad, '$foto', $categoria)");
        if ($query) {
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-color shadow-sm" id="abrirProducto"><i class="fas fa-plus fa-sm text-white-50"></i> Nuevo</a>
</div>
<div class="row">
    <div class="col-md-12">
                ...
                <tbody>
                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <form method="post" action="editar.php?accion=pro&id=<?php echo $data['id']; ?>" class="d-inline ">
                                    <button type="button" class="btn btn-color" data-toggle="modal" data-target="#myModalEditar"
                                    > Editar</button>
                                </form>
    ...
    <div id="myModalEditar" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
